...
export default function EventNotes({
  ...
  return (
    <div id="event-notes-container" className="bg-white border border-stone-200 p-6 shadow-sm flex flex-col justify-between h-full rounded-xl select-none">
      ...
      <div className="mt-6 border-t border-stone-100 pt-4 text-[10px] text-stone-400 flex justify-between items-center select-none font-mono">
        ...
        <span className="flex items-center gap-1">
          ...
          <span>ثبت در فایل server/data-store.json</span>
        </span>
      </div>
    </div>
  );
